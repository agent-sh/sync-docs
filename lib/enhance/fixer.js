...
// Object.prototype. The bracket-access branches already exclude these via a
// negative lookahead; plain `.foo` segments need the same guard before they
// index/assign into `current` (CodeQL js/prototype-polluting-assignment).
...
function applyAtPath(obj, pathStr, fixFn) {
  ...
  if (lastPart.includes('[')) {
    ...
    if (!isSafeKey(lastPart)) return result; // refuse prototype-polluting assignment
